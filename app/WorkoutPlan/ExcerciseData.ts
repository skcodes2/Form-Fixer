const ExerciseData = {
    ...
    Legs: [
        ...
        {
            "name": "Lunges",
            "description": "Step forward with one leg, lowering your body until your back knee nearly touches the floor.",
            "timePerRep": 2,
            "url": ""
        },
        {
        ...
        },
        {
            ...
            "description": "Use a barbell or dumbbells to lower the weight along your legs, targeting hamstrings and glutes.",
            "timePerRep": 3,
            "url": ""
        },
        {
    ...
    Shoulders: [
        {
            "name": "Overhead Press",
            "description": "Press a barbell or dumbbells overhead to target the shoulders.",
            "timePerRep": 2,
            "url": ""
        },
        {
